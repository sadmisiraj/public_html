                    ...
                    <div class="col-12">
                        <div class="row g-4">
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($walletBalance+0)}}</h4>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($interestBalance+0)}}</h4>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($totalDeposit+0)}}</h4>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($totalInterestProfit+0)}}</h4>
                    ...
                    <div class="col-12">
                        <div class="row g-4">
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($roi['totalInvestAmount']+0)}}</h4>
                                        <i class="fa-light fa-chart-network"></i>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($totalPayout+0)}}</h4>
                                        <i class="fa-light fa-chart-mixed"></i>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($totalBonus)}}</h4>
                                        <i class="fa-light fa-chart-pie-simple"></i>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-12">
                                <div class="card-box">
                                    <div class="d-flex justify-content-between">
                                        <h4>{{currencyPosition($totalTeamInvest)}}</h4>
                                        <i class="fa-light fa-file-chart-pie"></i>
                                    </div>
                                    <p class="mb-0">@lang('Team Investment')</p>
                                </div>
                            </div>
                        </div>
                    </div>
