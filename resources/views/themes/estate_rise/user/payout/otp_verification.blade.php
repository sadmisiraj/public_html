            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <p class="mb-0">@lang('For security reasons, please verify your identity before accessing your payout page.')</p>
                    </div>
...
<script>
    ...
    function sendOtp(method) {
        ...
        fetch(`{{ route('user.payout.otp.sms') }}`.replace('sms', method))
            .then(response => {
                if (!response.ok) {
