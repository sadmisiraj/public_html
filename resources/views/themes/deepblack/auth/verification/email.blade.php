                        ...
                        <form action="{{ route('user.mail.verify') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box mb-4">
                                        ...
                                        <div class="input-group">
                                            <div class="img">
                                                <img src="{{asset(template(true).'img/icon/padlock.png')}}" alt="@lang('email img')" />
                                            </div>
                                            <input
                                                type="text"
                                                name="code"
                                ...
                                <div class="col-lg-12 text-center mt-2">
                                    <p class="text-center">@lang('Didn\'t get Code? Click to') <a href="{{route('user.resend.code')}}?type=email"  class="golden-text"> @lang('Resend code')</a></p>
