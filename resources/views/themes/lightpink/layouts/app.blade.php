...
<script>
    ...
    root.style.setProperty('--theme_color', '{{primaryColor()??'#ff007a'}}');
    root.style.setProperty('--btn_bg1', '{{primaryColor()??'#ff007a'}}');
    root.style.setProperty('--theme_secondary_color', '{{secondaryColor()??'#8037c6'}}');
