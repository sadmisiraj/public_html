                ...
                <div class="row g-4 mb-4">
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box">
                            ...
                            <h3><small><sup>{{currencyPosition($walletBalance)}}</small></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-2">
                            ...
                            <h3><small><sup>{{currencyPosition($interestBalance)}}</small></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-3">
                            ...
                            <h3><small><sup>{{currencyPosition($totalDeposit)}}</small></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-4">
                            ...
                            <h3><small><sup>{{currencyPosition($totalInterestProfit)}}</small></h3>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box">
                            ...
                            <h3><small><sup>{{currencyPosition($roi['totalInvestAmount'])}}</small></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-2">
                            ...
                            <h3><small><sup>{{currencyPosition($totalPayout)}}</small></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-4">
                            ...
                            <h3><small><sup>{{currencyPosition($totalBonus)}}</small></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-3">
                            ...
                            <h3>{{currencyPosition($totalTeamInvest)}}</h3>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-2">
                            ...
                            <h3><small><sup>{{currencyPosition($lastBonus)}}</small></h3>
                            <i class="fal fa-box-open"></i>
                        </div>
                    </div>
                    ...
                    <div class="{{auth()->user()->rank ? 'col-xl-6':'col-xl-9'}}  col-md-12">
                        <div class="dashboard-box">
                            ...
                            <div class="input-group mb-3 cutom__referal_input__group">
                                <input type="text" class="form-control" value="{{route('register.sponsor',[Auth::user()->username])}}" id="jobLink" readonly>
