<section class="how-it-work @if(session()->get('rtl') == 1) rtl @endif">
    <div class="container">
        ...
        <div class="row g-4 g-lg-5">
            ...
            <div class="col-lg-6">
                <div class="img-box">
                    <img src="{{$how_works_section['single']['media']->image?getFile($how_works_section['single']['media']->image->driver,$how_works_section['single']['media']->image->path):''}}" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-6">
