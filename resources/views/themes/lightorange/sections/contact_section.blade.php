        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-4 col-md-6 wow fadeInLeftBig">
                <div class="single-item text-center">
                    <div class="icon-area">
                        <img src="{{asset(template(true).'images/icon/contact_icon_3.png')}}" alt="@lang('Phone image')">
                    </div>
                    <div class="text-area">
                        <p class="top">@lang('Call')</p>
                        <p class="area-para">{{$contact_section['single']['telephone']??''}}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="single-item text-center">
                    <div class="icon-area">
                        <img src="{{asset(template(true).'images/icon/contact_icon_2.png')}}" alt="@lang('Email image')">
                    </div>
                    <div class="text-area">
                        <p class="top">@lang('Email')</p>
                        <p class="area-para">{{$contact_section['single']['email']??''}}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInRightBig">
                <div class="single-item text-center">
                    <div class="icon-area">
                        <img src="{{asset(template(true).'images/icon/contact_icon_1.png')}}" alt="@lang('address image')">
                    </div>
                    <div class="text-area">
                        <p class="top">@lang('Location')</p>
                        <p class="area-para">{!! $contact_section['single']['location']??'' !!}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row d-flex justify-content-center text-center">
                <div class="col-lg-10">
                    <div class="section-header">
                        <h4 class="sub-title">{!! $contact_section['single']['heading']??'' !!}</h4>
                        <h3 class="title">{!! $contact_section['single']['sub_heading']??'' !!}</h3>
                    </div>
                </div>
            </div>
