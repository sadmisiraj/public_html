                        ...
                        <li class="header-left-list">
                            <p class="header-left-area">
                                    <span class="header-left-icon">
                                        ...
                                        <a href="mailto:{{$topbarsection['single']['email']??''}}">{{$topbarsection['single']['email']??''}}</a>
                                    </span>
                            </p>
                        </li>
                        <li class="header-left-list">
                            <p class="header-left-area">
                                    <span class="header-left-icon">
                                        ...
                                        <a href="tel:{{$topbarsection['single']['telephone']??''}}">{{$topbarsection['single']['telephone']??''}}</a>
                                    </span>
                            </p>
                        </li>
                    </ul>
                    ...
                    <div class="language-wrapper">
                        <div class="control-plugin">
                            <div class="language"
                                 ...
                                 data-selected-country="{{app()->getLocale()?app()->getLocale()=='en' ?'US' : app()->getLocale():'US'}}"
                                 data-button-size="btn-sm"
                                 data-button-type="btn-info"
                                 data-scrollable="true"
                                 data-scrollable-height="250px"
                                 data-countries='{{$languagesStr}}'>
                            </div>
                        </div>
                    </div>
                </div>
