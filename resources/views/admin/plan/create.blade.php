                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="tom-select-custom">
                                        <select class="js-select form-select" name="base_plan_id" autocomplete="off"
                                            ...
                                            @foreach($plans as $plan)
                                                <option value="{{$plan->id}}" @selected(old('base_plan_id') == $plan->id)>{{$plan->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error("base_plan_id")
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" name="gold_coin_id" id="gold_coin_id" autocomplete="off"
                                                ...
                                                @foreach($goldCoins as $coin)
                                                    <option value="{{$coin->id}}" @selected(old('gold_coin_id') == $coin->id)>{{$coin->name}} ({{$coin->karat}}k)</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error("gold_coin_id")
                                ...
                                @php $refLevels = old('referral_levels', 1); @endphp
                                    ...
                                    <div class="row">
                                        ...
                                        @for($lvl=1; $lvl<=10; $lvl++)
                                            <div class="col-md-3 mb-3 referral-percent-input" data-level="{{$lvl}}" style="display: {{ ($lvl <= $refLevels) ? 'block' : 'none' }};">
                                                ...
                                                <input type="number" step="0.01" min="0" class="form-control" name="referral_percent[{{$lvl}}]" value="{{ old('referral_percent.'.$lvl) }}" placeholder="e.g. 2.5">
                                            </div>
                                        @endfor
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-sm-auto d-flex align-items-center">
                                                        <div class="form-check form-switch form-switch-google">
                                                            ...
                                                            <input class="form-check-input" name="return_as_gold"
                                                                   type="checkbox" id="return_as_gold" value="1" @checked(old('return_as_gold') == 1)>
                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="col-sm-auto d-flex align-items-center">
                                                        <div class="form-check form-switch form-switch-google">
                                                            ...
                                                            <input class="form-check-input" name="allow_multiple_purchase"
                                                                   type="checkbox" id="allowMultiplePurchase" value="1" @checked(old('allow_multiple_purchase') == 1)>
                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="col-sm-auto d-flex align-items-center">
                                                        <div class="form-check form-switch form-switch-google">
                                                            ...
                                                            <input class="form-check-input" name="eligible_for_referral"
                                                                   type="checkbox" id="eligible_for_referral" value="1" @checked(old('eligible_for_referral') == 1)>
                                                            <label class="form-check-label"
