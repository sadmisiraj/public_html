                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gold_reward_type" id="gold_reward_fixed" value="0" {{ old('gold_reward_type', $data->gold_reward_type ?? 0) == 0 ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="gold_reward_fixed">@lang('Fixed weight per accrual')</label>
                                                </div>
                                                <input type="number" class="form-control mt-2 @error('gold_weight_in_grams') is-invalid @enderror" value="{{old('gold_weight_in_grams', $data->gold_weight_in_grams)}}" id="gold_weight_in_grams" name="gold_weight_in_grams" placeholder="e.g : 0.50" step="0.00000001">
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gold_reward_type" id="gold_reward_per_lakh" value="1" {{ old('gold_reward_type', $data->gold_reward_type ?? 0) == 1 ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="gold_reward_per_lakh">@lang('Coins per 1 lakh')</label>
                                                </div>
                                                <input type="number" class="form-control mt-2 @error('gold_coins_per_lakh') is-invalid @enderror" value="{{old('gold_coins_per_lakh', $data->gold_coins_per_lakh)}}" id="gold_coins_per_lakh" name="gold_coins_per_lakh" placeholder="e.g : 1" step="0.00000001">
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-auto d-flex align-items-center">
                                                        <div class="form-check form-switch form-switch-google">
                                                            <input type="hidden" name="eligible_for_referral" value="0">
                                                            <input class="form-check-input" name="eligible_for_referral"
                                                                   type="checkbox" id="eligible_for_referral" value="1" @checked(old('eligible_for_referral',$data->eligible_for_referral ?? 0) == 1)>
                                                            <label class="form-check-label"
                                                                   for="eligible_for_referral"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        @error('eligible_for_referral')
                                        <span class="ms-4 invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="list-group-item mb-4">
                                                    ...
                                                    <div class="col-sm-auto d-flex align-items-center">
                                                        <div class="form-check form-switch form-switch-google">
                                                            ...
                                                            <input class="form-check-input" name="eligible_for_rgp"
                                                                   type="checkbox" id="eligible_for_rgp" value="1" @checked(old('eligible_for_rgp',$data->eligible_for_rgp ?? 0) == 1)>
                                                            <label class="form-check-label"
