                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item">
                                <a class="breadcrumb-link" href="{{ route('admin.security.email.templates') }}">@lang('Email Settings')</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang("Edit Email Template")</li>
                        </ol>
                    </nav>
                            ...
                            <div class="tab-content">
                                @foreach($languages as $key => $value)
                                    <div
                                        ...
                                        <form method="post"
                                              action="{{ route('admin.security.email.template.content.update', [$template->id, $value->id]) }}"
