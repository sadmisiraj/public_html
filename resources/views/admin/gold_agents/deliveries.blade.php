            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">@lang('Delivered Gold Orders')</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                @forelse($orders as $order)
                                    <tr>
                                        ...
                                        <td>{{ $order->agent_delivered_at ? $order->agent_delivered_at->format('d M, Y H:i') : '-' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">@lang('No delivered orders found')</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
