...
@section('page_title', __('Create Offer Image'))
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang('Create Offer Image')</h1>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">@lang('Add New Offer Image')</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.offer-images.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="image" class="form-label">@lang('Image') <span class="text-danger">*</span></label>
