<div class="ccb-field-setting-wrapper">
  <div class="ccb-field-setting">
	<div class="ccb-field-setting-right">
	  <span class="ccb-field-setting-title"><?php esc_html_e( 'Formatted text', 'cost-calculator-builder-pro' ); ?></span>
	</div>
  ...
  <div class="ccb-field-setting-text">
	<div class="ccb-field-setting-title">
	  <span><?php esc_html_e( 'Title', 'cost-calculator-builder-pro' ); ?></span>
	</div>
  ...
  <div class="ccb-field-setting-text">
	<div class="ccb-field-setting-title">
	  <span><?php esc_html_e( 'Text', 'cost-calculator-builder-pro' ); ?></span>
	</div>
	<div class="ccb-field-setting-input">
	  <ccb-editor v-model="field.attributes.text" placeholder="<?php echo esc_attr__( 'Enter email description', 'cost-calculator-builder-pro' ); ?>" class="ccb-heading-5 ccb-light show-triangle"></ccb-editor>
	</div>
  </div>
