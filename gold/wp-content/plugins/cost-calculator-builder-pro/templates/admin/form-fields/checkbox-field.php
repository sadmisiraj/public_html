<div class="ccb-field-setting-wrapper">
  <div class="ccb-field-setting">
	<div class="ccb-field-setting-right">
	  <span class="ccb-field-setting-title"><?php esc_html_e( 'Checkbox', 'cost-calculator-builder-pro' ); ?></span>
	</div>
  ...
  <div class="ccb-field-setting-text">
	<div class="ccb-field-setting-title">
	  <span><?php esc_html_e( 'Title of Checkbox Group', 'cost-calculator-builder-pro' ); ?></span>
	</div>
