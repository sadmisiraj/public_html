<div class="ccb-field-setting-wrapper">
	<div class="ccb-field-setting">
		<div class="ccb-field-setting-right">
			<span class="ccb-field-setting-title"><?php esc_html_e( 'Date picker', 'cost-calculator-builder-pro' ); ?></span>
		</div>
	...
	<div class="ccb-field-setting">
		<div class="ccb-field-setting-right">
			<span class="ccb-field-setting-confirmation-title"><?php esc_html_e( 'Range date', 'cost-calculator-builder-pro' ); ?></span>
			<span class="ccb-options-tooltip"><i class="ccb-icon-circle-question"></i> <span class="ccb-options-tooltip__text" style="width: 200px !important; left: 33px;"><?php esc_html_e( 'Select a start and end date', 'cost-calculator-builder-pro' ); ?></span></span>
		</div>
		<div class="ccb-field-setting-left">
