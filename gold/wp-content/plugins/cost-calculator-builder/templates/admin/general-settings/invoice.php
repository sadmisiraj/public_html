<div class="ccb-tab-container" style="height: 100%; padding: 0; margin: 0; min-height: fit-content">
	<?php if ( ! defined( 'CCB_PRO' ) ) : ?>
		<settings-pro-banner
			...
			img="<?php echo esc_attr( CALC_URL . '/frontend/dist/img/pro-features/new-pdf-entries.webp' ); ?>"
			img-height="369px"
		/>
	<?php else : ?>
