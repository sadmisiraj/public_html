<div class="cbb-edit-field-container">
	<div class="ccb-edit-field-header">
		...
		<div class="ccb-field-actions">
			...
			<button class="ccb-button success" @click.prevent="$emit( 'save', htmlField, id, index, htmlField.alias, htmlField.label )"><?php esc_html_e( 'Save', 'cost-calculator-builder' ); ?></button>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="ccb-input-wrapper">
						...
						<input type="text" class="ccb-heading-5 ccb-light" v-model.trim="htmlField.label" placeholder="<?php esc_attr_e( 'Enter field name', 'cost-calculator-builder' ); ?>">
					</div>
