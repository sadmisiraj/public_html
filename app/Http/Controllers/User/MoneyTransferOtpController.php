...
class MoneyTransferOtpController extends Controller
{
    use Notify;
    ...
    public function showVerification()
    {
        ...
        $page_title = 'Money Transfer Verification';
        return view($this->theme . 'user.money_transfer.otp_verification', compact('user', 'page_title', 'maskedPhone', 'maskedEmail'));
    }
    ...
    public function sendOtpViaEmail()
    {
        ...
        $this->verifyToMail($user, 'TWO_FACTOR_AUTH', [
            'code' => $user->verify_code
        ], 'Money Transfer Verification Code');
    ...
    public function verifyOtp(Request $request)
    {
        ...
        if ($this->checkValidCode($user, $request->code)) {
            ...
            Session::put('money_transfer_otp_verified', true);
